...
ALTER TABLE ONLY "public"."volunteer_hours"
    ADD CONSTRAINT "volunteer_hours_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "public"."meetings"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."volunteer_hours"
    ADD CONSTRAINT "volunteer_hours_meeting_id_fkey" FOREIGN KEY ("meeting_id") REFERENCES "public"."meetings"("id") ON DELETE SET NULL;
